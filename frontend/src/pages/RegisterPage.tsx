...
// Public "Uye Ol" formu SADECE Yarismaci kaydi acar (bkz. api/auth.ts >
// PUBLIC_REGISTER_ROLE) — diger roller icin ayri bir rol secimi burada YOK,
// yeni kullanicilar sadece Sistem Yoneticisi panelinden acilabilir.
